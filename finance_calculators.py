...
# I needed to import the math modul
#Simple instuction for the user to choose
...
#reason for this step is incase the user inputs the vaule in a diffrent format
...
# print to the answer to the screen, This is rounded to 2 digits.
